package boyer01120930.playstyles;

import battlecode.common.*;
import boyer01120930.*;
...
public class LauncherPlaystyle extends Playstyle {
	...
	public LauncherPlaystyle() {
		...
		this.minerRatios =       new double[] { 0.00, 0.00, 0.40, 0.30, 0.30, 0.50, 0.55, 0.40, 0.20, 0.20, 0.05, 0.05, 0.05, 0.05 };
		...
		this.launcherRatios =    new double[] { 0.00, 0.00, 0.10, 0.45, 0.65, 0.45, 0.40, 0.60, 0.70, 0.70, 0.85, 0.85, 0.85, 0.85 };
