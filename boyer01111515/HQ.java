...
import boyer01111515.movement.MovementController;
import boyer01111515.playstyles.*;
				...
				if (towers >= 5) {
					...
					for (RobotInfo enemy : enemies) {
						...
						if (distance <= 42) {
							...
							Direction direction = currentLocation.directionTo(enemy.location);
							MapLocation attackLocation = currentLocation.add(direction, (int)Math.floor(Math.sqrt(35)));
