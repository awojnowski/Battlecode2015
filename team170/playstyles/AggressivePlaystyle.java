...
public class AggressivePlaystyle extends Playstyle {
	...
	public AggressivePlaystyle() {
		...
		this.civicRatios =   new double[] { 0.50, 0.50, 0.50, 0.50, 0.50, 0.50, 0.50, 0.35, 0.35, 0.35, 0.35,  0.35,  0.35,  0.35,  0.0 };
		// CIVIC RATIO IS % OF MONEY ALLOCATED TO ECON, RATIOS BELOW ARE AMOUNT OF UNIT TYPE TO ALL UNITS
		this.beaverRatios =  new double[] { 1.00, 0.80, 0.50, 0.10, 0.10, 0.10, 0.05, 0.05, 0.05, 0.05, 0.025, 0.025, 0.025, 0.025, 0.025 };
		this.minerRatios =   new double[] { 0.00, 0.20, 0.50, 0.80, 0.50, 0.50, 0.30, 0.30, 0.30, 0.30, 0.20,  0.20,  0.20,  0.20,  0.20 };
		this.soldierRatios = new double[] { 0.00, 0.00, 0.00, 0.10, 0.40, 0.20, 0.10, 0.10, 0.10, 0.10, 0.10,  0.10,  0.10,  0.10,  0.10 };
