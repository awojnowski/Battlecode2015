...
public class RobotPlayer {
	...
	public static void run(RobotController robotController) {
		...
		} else if (robotController.getType() == TechnologyInstitute.type()) {
			
			robot = new TechnologyInstitute(robotController);
			
		} else if (robotController.getType() == TrainingField.type()) {
			
			robot = new TrainingField(robotController);
			
		} else if (robotController.getType() == Commander.type()) {
